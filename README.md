...
@blazoncek, proposed for WLED mainline), applied to the source tree **before building the
firmware**. It is entirely optional: without it everything works and links are configured
